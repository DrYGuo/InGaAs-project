function [ratio,ratio2,log_ratio,U200]=Blochwave(FPARAMS,ABSratio,structure)
%--------------------TILTE----------------------------------
...
%from the book by Zuo & Spence (2016). The conventions for Sg,direction of zone axis follows his own thesis. Please see Fig.2.2  
...
%read atomic numbers, Z, from the structure file
...
ZA=[0 0 1]; %zone axis;
SN=[42 -17 714];%surface normal
Kt=[0 16 0]; %the projection of the wave vector Kt=Kt1*astar+Kt2*bstar+Kt3*cstar Kt=[Kt1,Kt2,Kt3]
...
Kz=sqrt(K0^2-Kt*Metric*Kt')*ZAK/ZAK_length; %Unit  [Kz1 A-1,Kz2 A-1,Kz3 A-1] rather than [Kz1 a*, Kz2 b*, Kz3 c*]
Kz(1)=Kz(1)/astar;
Kz(2)=Kz(2)/bstar;
Kz(3)=Kz(3)/cstar;
% Now Kz=Kz1 a* + Kz2 b* + Kz3 c*, therefore Kz has the same coordinates as
